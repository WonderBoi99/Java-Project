...
John Kvellestad, 10125207
Aashik Ilangovan, 30085993
Nikhil Naikar, 30039350

To run the program, compile the edu/ucalgary/ensf409/DataHandler.java file with included lib/mysql-connector-java-8.0.23.jar
...
NOTE: the amount must be a numeral 
